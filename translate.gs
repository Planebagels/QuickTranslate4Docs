// apps script uses a heavily modified version of javascript, that's why the file extention has ".gs"
function onOpen(e) {
...
//this google docs add-on only works in the desktop/site version, and is not mobile freindly 
...
function showSidebar() {
  var ui = HtmlService.createHtmlOutputFromFile('sidebar')
      .setTitle('quick translater for google docs, by Mansour Quddus');
...
function getTextAndTranslation(origin, dest, savePrefs) {
  ...
  return {
    text: text,
    translation: translateText(text, origin, dest)//translates what the user wrote into the destination language or what language the user has chosen, defualt is japanese
  };
}
